...
/**
 * this is a class for all kinds of soup
 * @author ADY
 * @since 2014-11-15
 */
public class Soup implements IFood{
	 ...
	 * @param name name of a specific soup
	 */
	...
	public void SpecifyQuantity(String customerChoice, int numberOfChoices) {
		if(customerChoice.equalsIgnoreCase("Barley"))
			System.out.println("Quantity of Barley soup required is "+numberOfChoices+"servings.");
		if(customerChoice.equalsIgnoreCase("Ajiaco"))
			System.out.println("Quantity of Ajiaco soup required is "+numberOfChoices+"servings.");
